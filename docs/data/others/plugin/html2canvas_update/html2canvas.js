...
//# edit =======================================================================
        ...
        var _node = node.isDisableTransformOfWrapper ? node : node.originNode;
        var style = defaultView.getComputedStyle(_node, null);
...
//# add ========================================================================
            if (options.isDisableTransformOfWrapper) {
                clonedElement.isDisableTransformOfWrapper = true;
                var transform    = clonedElement.style.transform;
                var transformArr = transform.split(" ");
                var scale        = transformArr.shift();
                var newTransform = "translateX(" + window.tyranoDivInfo.width + "px) translateY(" + window.tyranoDivInfo.height + "px)";
                clonedElement.style.transformOrigin = "initial";
                clonedElement.style.transform = newTransform;
            }
//==============================================================================
